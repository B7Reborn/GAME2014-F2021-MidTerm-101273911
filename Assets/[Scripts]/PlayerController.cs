 ...
 * Description      : Controls the character movement via touch (and mouse click for testing purposes)
 * Revision History : V 1.0 - Changed controls and boundaries to fit landscape orientation
 */
